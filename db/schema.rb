...
ActiveRecord::Schema.define(version: 2021_03_30_231918) do
  ...
  create_table "agreements_questionnaires", id: false, force: :cascade do |t|
  ...
  create_table "bus_lists", id: :serial, force: :cascade do |t|
    t.string "name"
    t.datetime "created_at"
  ...
  create_table "fips", id: :serial, force: :cascade do |t|
    t.string "fips_code"
    t.string "city"
    t.string "state"
    t.datetime "created_at"
  ...
  create_table "school_name_duplicates", id: :serial, force: :cascade do |t|
    t.string "name"
    t.integer "school_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "trackable_tags", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
